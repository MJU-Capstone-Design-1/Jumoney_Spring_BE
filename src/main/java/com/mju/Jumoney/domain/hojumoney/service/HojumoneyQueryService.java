...
import com.mju.Jumoney.domain.hojumoney.repository.HojumoneyRecommendationRepository;
...
public class HojumoneyQueryService {
    ...
    public HojumoneyRecommendationResponse getLatestRecommendation(Long userId) {
        Recommendation recommendation = recommendationRepository
                ...
                .orElseThrow(() -> new CustomException(HojumoneyErrorCode.HOJUMONEY_RECOMMENDATION_NOT_FOUND));
