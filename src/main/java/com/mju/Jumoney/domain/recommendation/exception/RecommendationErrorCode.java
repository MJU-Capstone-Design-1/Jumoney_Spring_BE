...
public enum RecommendationErrorCode implements BaseErrorCode {
    ...
    MASTER_NOT_FOUND(HttpStatus.NOT_FOUND, "RECOMMENDATION404_MASTER", "거장을 찾을 수 없습니다."),
    ...
    HOJUMONEY_RECOMMENDATION_NOT_FOUND(HttpStatus.NOT_FOUND, "RECOMMENDATION404_HOJUMONEY_RESULT", "오늘의 호주머니 추천 결과를 찾을 수 없습니다."),
    INVALID_MASTER_OPTION_SELECTION(HttpStatus.BAD_REQUEST, "RECOMMENDATION400_MASTER_OPTION", "선택한 거장에 사용할 수 없는 조건이 포함되어 있습니다."),
    MISSING_MASTER_SECTOR_SELECTION(HttpStatus.BAD_REQUEST, "RECOMMENDATION400_MASTER_SECTOR", "선택한 거장 조건에는 섹터 선택이 필요합니다."),
    UNSUPPORTED_MASTER_SECTOR_SELECTION(HttpStatus.BAD_REQUEST, "RECOMMENDATION400_UNSUPPORTED_MASTER_SECTOR", "선택한 거장 조건에서는 섹터를 사용할 수 없습니다."),
