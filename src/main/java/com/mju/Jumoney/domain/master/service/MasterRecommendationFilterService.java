...
public class MasterRecommendationFilterService {
    ...
    public List<MasterRecommendationCandidate> findCandidates(
        ...
        List<MasterRecommendationCandidate> candidates = new ArrayList<>();
        for (StockIndicator indicator : indicators) {
            MasterRecommendationCandidate candidate = evaluate(indicator, logicCodes, sectorTypes);
    ...
    private MasterRecommendationCandidate evaluate(
            StockIndicator indicator,
            Set<MasterOptionLogicCode> logicCodes,
            Set<SectorType> selectedSectorTypes
    ) {
        MasterRecommendationCandidate candidate = new MasterRecommendationCandidate(indicator);
