...
| 2 | 국내주식 재무비율 | `FHKST66430300` | 영업이익증가율, ROE, EPS, 부채비율 |
| 3 | 국내주식 손익계산서 | `FHKST66430200` | 매출액, 영업이익 |
| 4 | 예탁원정보 배당일정 | `HHKDB669102C0` | 주당배당금, 배당 기준일 |
| 5 | 국내주식 신용잔고 일별추이 | `FHPST04760000` | 전체 융자 잔고 비율 |
| 6 | 종목별 투자자매매동향 일별 | `FHPTJ04160001` | 기관계 순매수 수량 |
...
| 국내주식 실시간체결가 | `H0STCNT0` | 체결강도 `CTTR`, 웹소켓 기반 |
